...
class MyWebSocketServer(tornado.websocket.WebSocketHandler):
    ...
    def on_message(self, message):
        ...
        if (message=='stop'):
            ...
            self.tmux.kill('orazio')
            self.tmux.kill('state_pub_robot')
            time.sleep(3)
            self.tmux.killall(1)
            self.checkStatus()
            ...
            self.tmux.kill('usb_cam')
            self.tmux.kill('state_pub_usbcam')
            time.sleep(3)
            self.tmux.killall(3)
            time.sleep(3)
            self.checkStatus()
            ...
            self.tmux.kill('astra')
            self.tmux.kill('state_pub_astra')
            time.sleep(3)
            self.tmux.killall(3)
            time.sleep(3)
            self.checkStatus()
            ...
            self.tmux.kill('xtion')
            self.tmux.kill('state_pub_xtion')
            time.sleep(3)
            self.tmux.killall(3)
            time.sleep(3)
            self.checkStatus()
            ...
            self.tmux.kill('hokuyo')
            self.tmux.kill('state_pub_laser')
            time.sleep(3)
            self.tmux.killall(2)
            time.sleep(3)
            self.checkStatus()
            ...
            self.tmux.kill('astra')
            self.tmux.kill('depth2laser')
            self.tmux.kill('state_pub_astra_laser')
            time.sleep(3)
            self.tmux.killall(2)
            time.sleep(3)
            self.checkStatus()
            ...
            self.tmux.kill('xtion')
            self.tmux.kill('depth2laser')
            self.tmux.kill('state_pub_xtion_laser')
            time.sleep(3)
            self.tmux.killall(2)
            time.sleep(3)
            self.checkStatus()
